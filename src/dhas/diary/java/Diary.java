...
public class Diary {
    ...
    public static void getTherapy(int drugChoice) {
        switch (drugChoice) {
            case 1 -> System.out.println("Пациент получил курс внутрипузырной терапии препаратом Доксорубицин 50 мг в/п, экспозиция препарата в мочевом пузыре 2 часа, перенес удовлетворительно.");
            case 2 -> System.out.println("Пациент получил курс внутрипузырной терапии препаратом Имурон-Вак 100 мг в/п, экспозиция препарата в мочевом пузыре 2 часа, перенес удовлетворительно.");
            case 3 -> System.out.println("Пациент получил курс ХТ препаратом Доцетаксел 75 мг/м2 в/в, перенес удовлетворительно.");
            case 4 -> System.out.println("Пациент получил курс АДТ препаратом Трипторелин 11,25 мг п/к, перенес удовлетворительно.");
        }
    }
