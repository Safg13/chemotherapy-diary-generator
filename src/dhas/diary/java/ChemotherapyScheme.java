...
public class ChemotherapyScheme {
    ...
    public static void getSchemeMonday7(String dateOfHospitalisation, int drugChoice) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
        Calendar calendarOf2ndDiary = Calendar.getInstance(); //создаем объект календаря
        calendarOf2ndDiary.setTime(sdf.parse(dateOfHospitalisation)); //парсим его в строку
        Calendar calendarOf3rdDiary = Calendar.getInstance();
    ...
    public static void getSchemeTuesday7(String dateOfHospitalisation, int drugChoice) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
        Calendar calendarOf2ndDiary = Calendar.getInstance(); //создаем объект календаря
        calendarOf2ndDiary.setTime(sdf.parse(dateOfHospitalisation)); //парсим его в строку
        Calendar calendarOf3rdDiary = Calendar.getInstance();
    ...
    public static void getSchemeWednesday7(String dateOfHospitalisation, int drugChoice) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
        Calendar calendarOf2ndDiary = Calendar.getInstance(); //создаем объект календаря
        calendarOf2ndDiary.setTime(sdf.parse(dateOfHospitalisation)); //парсим его в строку
        Calendar calendarOf3rdDiary = Calendar.getInstance();
    ...
    public static void getSchemeThursday7(String dateOfHospitalisation, int drugChoice) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
        Calendar calendarOf2ndDiary = Calendar.getInstance(); //создаем объект календаря
        calendarOf2ndDiary.setTime(sdf.parse(dateOfHospitalisation)); //парсим его в строку
        Calendar calendarOf3rdDiary = Calendar.getInstance();
    ...
    public static void getSchemeFriday7(String dateOfHospitalisation, int drugChoice) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
        Calendar calendarOf2ndDiary = Calendar.getInstance(); //создаем объект календаря
        calendarOf2ndDiary.setTime(sdf.parse(dateOfHospitalisation)); //парсим его в строку
        Calendar calendarOf3rdDiary = Calendar.getInstance();
    ...
    public static void getScheme1(String dateOfHospitalisation, int drugChoice) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");//создаем формат дат
        Calendar calendarOf2ndDiary = Calendar.getInstance(); //создаем объект календаря
        calendarOf2ndDiary.setTime(sdf.parse(dateOfHospitalisation)); //парсим его в строку
        ...
        int weekDay = calendarOf2ndDiary.get(Calendar.DAY_OF_WEEK); //определяем день недели
